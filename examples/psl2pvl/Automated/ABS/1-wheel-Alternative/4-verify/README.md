...
- Furthermore add `rasi.pvl` as invariant before global invariant 
- Lastly, add reference to `this.reachable_abstract_states_invariant()` before this.psl_invariant() reference in the global_invariant()
